...
| T111 | 投递列表滚动加载全量（T105 补全） | P0 | T105 | pages/inbox.ts | done |
| T112 | positions --candidates 按职位拉取候选人/投递列表 | P1 | T111、T105、T306 | pages/job.ts、pages/selectors.ts、index.ts | done |
...
| T403 | README / CAPABILITIES / AGENTS / RELEASE 同步 | P2 | 多数任务后 | README.md、docs/CAPABILITIES.md、AGENTS.md、RELEASE.md | done |
